...
export const paintText = () => {
  let $splash = $("<section class='splash paint-splash menu about'></section>");
  let $p2 = $("<p></p>").text("Paint mode allows you to paint on simulations, or clear the canvas and make your own!");
  let $p3 = $("<p></p>").text("Just pick a color to start painting with and click to paint.  Pressing 'pause on paint' pauses the simulation while you're painting.");
  let $p4 = $("<p></p>").text("If you clear the canvas and create your own, I highly suggest using three colors, since every color is required to create a repeating pattern.");
  let $p5 = $("<p></p>").text("To see this message again, click the question mark in the top left corner of the paint box.")
